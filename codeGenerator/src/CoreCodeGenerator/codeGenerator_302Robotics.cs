...
namespace CoreCodeGenerator
{
    public class codeGenerator_302Robotics : baseReportingClass
    {
        ...
        private void copyrightAndGenNoticeAndSave(string outputFilePathName, string contents)
        {
            ...
            File.WriteAllText(getOutputFileFullPath(outputFilePathName), contents);
        }

        private string getGenerationInfo()
        {
            return string.Format("// This file was automatically generated by the Team 302 code generator version {0}{1}// Generated on {2} {3}", 
                codeGeneratorVersion, Environment.NewLine, DateTime.Now.ToLongDateString(), DateTime.Now.ToLongTimeString());
        }
